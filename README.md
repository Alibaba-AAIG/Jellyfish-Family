...
|-----------------------|------------------------------------------|----------------------|----------------------|
  ...
  [**LASA**]([https://github.com/yangjunx21/LASA](https://github.com/thu-coai/lasa-multilingual-safety)  |针对低资源语种安全性差的问题，对模型进行中间层语义的安全对齐，仅在高资源语种上后训练便可泛化到低资源语种。 |杨峻骁|清华大学|
